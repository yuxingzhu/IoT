<template>
  <div>
    <div v-if="!isChildren" class="app-container datakanbanData-container">
      <el-row v-loading="listLoading" class="datakanbanData">
        <el-col v-for="item in list" :key="item.displayBoardId" :span="5" style="margin-top:20px;margin-left: 3%;" class="board">
          <div class="platform">
...
export default {
  ...
  methods: {
    ...
    details(row) {
      this.$router.push(`/dataDisplay?displayBoardId=${row.displayBoardId}`)
    }
  }
}
</script>
