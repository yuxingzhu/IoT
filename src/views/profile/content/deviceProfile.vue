  ...
  <div>
    <div class="app-container">
        ...
        <el-row>
          <el-col :span="20" class="table-filter">
            <el-form ref="filterForm" :inline="true" :model="listQuery" label-width="0px" class="filterForm">
              <el-form-item>
                <el-tooltip content="上传设备模型">
                  <el-button class="filter-item" icon="el-icon-upload" @click="openPartnerEditDialog()"> </el-button>
                </el-tooltip>
              </el-form-item>
              <el-form-item>
                <el-input v-model.trim="listQuery.profileName" :maxlength="20" placeholder="设备模型名称"></el-input>
              </el-form-item>
              <el-form-item>
      ...
      <el-table ref="multipleTable" v-loading="listLoading" :data="list" stripe size="mini" tooltip-effect="dark" style="width: 100%;">
        ...
        <el-table-column label="设备模型名称" prop="profileName" align="center" />
...
<script>
import { getList, saveResource, deletePartner } from '@/api/deviceProfile'
