...
export default {
  ...
  methods: {
    ...
    getRoutes() {
      ...
      setTimeout(() => {
        if (this.routes !== this.$router.options.routes) {
          this.routes = this.$router.options.routes
        }
      }, 500)
    }
...
.tags-view-container {
  height: 34px;
  width: 100%;
  background: $tags-view-container;
  border-bottom: 0px solid #495060;
  ...
  .tags-view-wrapper {
    .tags-view-item {
      ...
      height: 26px;
      line-height: 26px;
      border: 1px solid $navbar-unactive;
      color: #fff;
      background: $navbar-unactive;
      padding: 0 8px;
      font-size: 12px;
      margin-left: 5px;
      margin-top: 4px;
