...
export function findByAgwId(params) {
  return request({
    url: '/feEdgeDevice/findByAgwId',
    method: 'get',
    params: params
  })
}

export function pasteDevice(params) {
  return request({
    url: '/feEdgeDevice/pasteDevice',
    method: 'get',
    params: params
  })
}

export function saveFeDeviceDesc(params) {
  return request({
    url: '/neDevice/changeDeviceDesc',
    method: 'get',
    params: params
  })
}
