...
export const constantRoutes = [
  ...
  },
  {
    ...
    alwaysShow:true,
    name:"应用管理",
    meta: { title: '应用管理', icon: 'app_manage' },
    resourceId:"105",
    parentResourceId:"1",
    index:4,
    resourceNode:"appmanage",
    children: [{
    path: '/appstore',
    name: '应用',
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    children: [{
      path: '/datafilterConfig',
      name: '清洗策略',
      component: componentsMap.datafilterConfig,
      meta: { title: '清洗策略', icon: '' },
      children:[
        {
    path: '/filterConfig',
    name: '策略配置1',
  ...
  },
  {
    path: '/dataAccess',
    component: Layout,
    meta: { title: '数据接入', icon: 'data_access' },
    redirect: 'noRedirect',
    children: [{
    path: '/authentication',
    name: '接入认证',
  ...
  },
  {
    path: '/dataBoard',
    component: Layout,
    meta: { title: '数据看板', icon: 'fullscreen' },
    redirect: 'noRedirect',
    children: [
    {
    path: '/dataBoard',
...
// export function asyncRouters() {
// asyncRoutes().then(response => {
// if (response.success) {
// const asyncRoutes = []
...
// child.component = componentsMap[child.resourceNode]
// child.children = childrenMap[child.resourceNode]
// })
// } else {
// item.children = childrenMap[item.resourceNode]
// }
// asyncRoutes.push(item)
// })
